...
if(isset($_POST['submit'])){
	...
	$sql="select * from restaurants where email='$username' and password='$password'";
...
<head>
  ...
  <title>Food Ordering Resturant Login</title>
  <!-- plugins:css -->
              ...
              <form class="pt-3" method="post">
                ...
                <div class="mt-3">
                  <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="SIGN IN" name="submit"/>
                    ...
                    <a href="signup.php" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Signup</a>
