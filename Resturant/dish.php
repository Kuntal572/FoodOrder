...
$sql="select dish.*,category.category from dish,category,restaurants where dish.category_id=category.id and category.r_id=restaurants.r_id AND restaurants.r_id=".$Res_Id." order by dish.id desc;";
