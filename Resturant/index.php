	...
	<div class="col-md-6 col-lg-3 grid-margin stretch-card">
	  <div class="card">
		<div class="card-body">
		  <h1 class="font-weight-light mb-4">
			<?php 
			$qu="SELECT count(order_detail.dish_details_id) as t, dish.dish from order_detail,dish_details,dish,restaurants WHERE order_detail.dish_details_id=dish_details.id and dish_details.dish_id=dish.id and dish_details.r_id=restaurants.r_id and order_detail.r_id=restaurants.r_id and restaurants.r_id=".$Res_Id." group by order_detail.dish_details_id order by count(order_detail.dish_details_id) desc limit 1";
			$row=mysqli_fetch_assoc(mysqli_query($con,$qu));
			echo $row['dish'];
			echo "<br/>";
